...
namespace CommonLibrary.Common.Web.DelegatingHandlers
{
    using System;
    using System.Net;
                ...
                async () =>
                {
                    try
                    {
                        ...
                        while (DateTime.UtcNow < timeout)
                        {
                            ...
                            newRequest.Headers.Authorization = new AuthenticationHeaderValue(CommonLibrary.Common.Base.Constants.BearerAuthenticationScheme, token);
