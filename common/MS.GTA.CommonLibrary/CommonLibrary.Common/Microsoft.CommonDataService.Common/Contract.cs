...
namespace CommonLibrary.CommonDataService.Common
{
    /// <summary>
    ...
    /// </summary>
    [Obsolete("These APIs are obsolete and will be removed in a future release. Use an implementation under the CommonLibrary.CommonDataService.Common.Internal namespace instead.")]
