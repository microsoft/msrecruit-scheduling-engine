...
namespace CommonLibrary.Common.Product.ServicePlatform.Instrumentation.ApplicationInsights
{
    ...
    /// </summary>
    /// <seealso cref="CommonLibrary.Common.Product.ServicePlatform.Instrumentation.ITraceEventProvider" />
