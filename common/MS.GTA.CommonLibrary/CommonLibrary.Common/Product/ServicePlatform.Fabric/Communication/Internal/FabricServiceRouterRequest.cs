...
using PlatformServiceContext = CommonLibrary.ServicePlatform.Context.ServiceContext;

namespace CommonLibrary.ServicePlatform.Fabric.Communication.Internal
{
