//----------------------------------------------------------------------------
// <copyright file="MeetingDetails.cs" company="Microsoft Corporation">
...
namespace MS.GTA.ScheduleService.Contracts.V1
{
    ...
    public class MeetingDetails
    {
        ...
        // TODO: Remove after teams integration
        /// <summary>
        /// Gets or sets a value indicating online meeting type.
        /// </summary>
        [DataMember(Name = "skypeMeetingType", IsRequired = false, EmitDefaultValue = true)]
