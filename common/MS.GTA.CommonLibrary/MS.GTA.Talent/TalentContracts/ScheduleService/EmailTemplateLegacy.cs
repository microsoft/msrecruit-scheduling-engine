...
namespace MS.GTA.ScheduleService.Contracts.V1
{
    ...
    /// </summary>
    [DataContract]
    public class EmailTemplateLegacy
    {
        /// <summary>
        ...
        public List<GraphPerson> primaryEmailRecipients { get; set; }

        /// <summary>
        /// Gets or sets  Email Content
        /// </summary>
        [DataMember(Name = "emailContent", IsRequired = false)]
        public List<EmailContent> EmailContent { get; set; }
