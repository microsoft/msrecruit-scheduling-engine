...
namespace TA.CommonLibrary.Common.Email
{
    ...
    using TA.CommonLibrary.Common.Common.Common.Email;
    using TA.CommonLibrary.Common.Common.Common.Email.Contracts;
    using TA.CommonLibrary.Common.Email.Exceptions;
    using TA.CommonLibrary.Common.Email.GraphContracts;
    using TA.CommonLibrary.Common.Email.SendGridContracts;
    using TA.CommonLibrary.Common.MSGraph;
    using TA.CommonLibrary.Common.MSGraph.Configuration;
    using TA.CommonLibrary.Common.TestBase;
    using TA.CommonLibrary.CommonDataService.Common;
