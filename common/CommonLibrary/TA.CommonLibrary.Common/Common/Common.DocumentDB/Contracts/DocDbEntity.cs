...
namespace TA.CommonLibrary.Common.DocumentDB.Contracts
{
    using System;
    using System.Runtime.Serialization;

    using TA.CommonLibrary.Common.DocumentDB.Attributes;
    using TA.CommonLibrary.Common.DocumentDB.Enums;
