...
namespace CommonLibrary.Common.MSGraph.Exceptions
{
    using System;
    ...
    [Serializable]
    [MonitoredExceptionMetadata(HttpStatusCode.ServiceUnavailable, "CommonLibrary.Common.MsGraph", "MsGraphServiceUnavailableException", MonitoredExceptionKind.Service)]
    public sealed class MsGraphServiceUnavailableException : MonitoredException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonLibrary.Common.MSGraph.Exceptions.MsGraphServiceUnavailableException" /> class.
        /// </summary>
    ...
    [SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass", Justification = "Small closely related classes may be combined.")]
    [Serializable]
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "CommonLibrary.Common.MsGraph", "MsGraphInvalidInputException", MonitoredExceptionKind.Service)]
    public sealed class MsGraphInvalidInputException : MonitoredException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommonLibrary.Common.MSGraph.Exceptions.MsGraphInvalidInputException" /> class.
        /// </summary>
        /// <param name="exception">Exception during graph call.</param>
    ...
    [SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass", Justification = "Small closely related classes may be combined.")]
    [Serializable]
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.MsGraph", "AcquireGraphTokenException", MonitoredExceptionKind.Service)]
