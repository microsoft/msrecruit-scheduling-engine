...
namespace TA.CommonLibrary.Common.MSGraph
{
    ...
    using TA.CommonLibrary.Common.Common.Common.MsGraph.Helpers;
    ...
    public class MsGraphProvider : IMsGraphProvider, IDisposable
    {
        ...
        /// </summary>
        [Obsolete("Please use the user directory service client implementation for any future work on MSGraph")]
        public void Dispose()
        {
            this.Dispose(false);
        }
