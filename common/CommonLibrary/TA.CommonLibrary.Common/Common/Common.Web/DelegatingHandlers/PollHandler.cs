...
namespace TA.CommonLibrary.Common.Web.DelegatingHandlers
{
    using System;
    using System.Net;
                ...
                async () =>
                {
                    try
                    {
                        ...
                        while (DateTime.UtcNow < timeout)
                        {
                            ...
                            newRequest.Headers.Authorization = new AuthenticationHeaderValue(TA.CommonLibrary.Common.Base.Constants.BearerAuthenticationScheme, token);
