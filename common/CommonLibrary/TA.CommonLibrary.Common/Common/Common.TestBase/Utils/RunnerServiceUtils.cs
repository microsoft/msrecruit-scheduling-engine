...
namespace TA.CommonLibrary.Common.TestBase.Utils
{
    using System;
    ...
    using TA.CommonLibrary.Common.Base.KeyVault;
    ...
    using TA.CommonLibrary.Common.Routing.DocumentDb;
    using TA.CommonLibrary.Common.TestBase.Contracts;
