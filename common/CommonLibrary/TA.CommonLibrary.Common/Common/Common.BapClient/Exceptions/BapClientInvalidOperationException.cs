...
namespace TA.CommonLibrary.Common.BapClient.Exceptions
{
    ...
    /// </summary>
    [Serializable]
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "TA.CommonLibrary.Common.BapClient.Exceptions", nameof(BapClientInvalidOperationException), MonitoredExceptionKind.Benign)]
