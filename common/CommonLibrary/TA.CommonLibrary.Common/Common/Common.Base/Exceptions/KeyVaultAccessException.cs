...
namespace TA.CommonLibrary.Common.Base.Exceptions
{
    ...
    /// </summary>
    [Serializable]
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.Base.Exceptions", "KeyVaultAccessError", MonitoredExceptionKind.Service)]
