...
namespace TA.CommonLibrary.Common.XrmHttp
{
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", nameof(XrmHttpClientResponseException), MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMBadRequest", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotFound, "TA.CommonLibrary.Common.XrmHttp", "XRMNotFound", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.Unauthorized, "TA.CommonLibrary.Common.XrmHttp", "XRMUnauthorized", MonitoredExceptionKind.Benign)]
    public class XrmHttpClientUnauthorizedResponseException : XrmHttpClientResponseException
    {
        ...
        [ExceptionCustomData(Name = TA.CommonLibrary.Common.Base.Constants.ExceptionErrorTypeName, PrivacyLevel = PrivacyLevel.PublicData, Serialize = true)]
        public int ErrorType => (int)Base.ErrorType.Benign;
    }

    [MonitoredExceptionMetadata(HttpStatusCode.Forbidden, "TA.CommonLibrary.Common.XrmHttp", "XRMForbidden", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.BadGateway, "TA.CommonLibrary.Common.XrmHttp", "XRMBadGateway", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMPreconditionFailed", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMTooManyRequests", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMConflict", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMInternalServerError", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", nameof(XrmHttpClientCustomerPluginException), MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMPluginExecutionFailedException", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XrmMissingAK", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XrmRequestHeadersTooLong", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMUnrecognizedPath", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMUnknownProperty", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "TA.CommonLibrary.Common.XrmHttp", "XRMValidationFailed", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "TA.CommonLibrary.Common.XrmHttp", "XRMInvalidCharactersInField", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotFound, "TA.CommonLibrary.Common.XrmHttp", "XRMUserDisabled", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMDuplicateKeyValues", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMDuplicateAlternateKeyValues", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.Forbidden, "TA.CommonLibrary.Common.XrmHttp", "XRMNoUserRolesAssigned", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "TA.CommonLibrary.Common.XrmHttp", "XRMOrganizationServiceFault", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotImplemented, "TA.CommonLibrary.Common.XrmHttp", "XRMRelevanceSearchNotAllowed", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotImplemented, "TA.CommonLibrary.Common.XrmHttp", "XRMFetchXMLAggregateQueryRecordLimitExceeded", MonitoredExceptionKind.Remote)]
