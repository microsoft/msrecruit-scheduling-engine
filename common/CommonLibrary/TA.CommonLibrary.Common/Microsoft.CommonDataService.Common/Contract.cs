...
namespace TA.CommonLibrary.CommonDataService.Common
{
    /// <summary>
    ...
    /// </summary>
    [Obsolete("These APIs are obsolete and will be removed in a future release. Use an implementation under the TA.CommonLibrary.CommonDataService.Common.Internal namespace instead.")]
    internal static class Contract
    {
        ...
        /// <summary>
        /// Used to validate that the value is within a range starting from <parameref name="inclusiveLowerBound"/> inclusive but less than <paramref name="exclusiveUpperBound"/>
        /// </summary>
        /// <param name="value">The value to test</param>
        /// <param name="inclusiveLowerBound">The inclusive lower bound of the range</param>
        /// <param name="exclusiveUpperBound">The exclusive upper bound of the range</param>
