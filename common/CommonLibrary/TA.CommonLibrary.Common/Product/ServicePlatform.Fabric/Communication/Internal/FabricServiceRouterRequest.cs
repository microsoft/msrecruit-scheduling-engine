...
using PlatformServiceContext = TA.CommonLibrary.ServicePlatform.Context.ServiceContext;

namespace TA.CommonLibrary.ServicePlatform.Fabric.Communication.Internal
{
