...
namespace TA.CommonLibrary.Data.DataAccess
{
    ...
    using TA.CommonLibrary.Common.Routing.Client;
    ...
    public class EmailTemplateDataAccess : IEmailTemplateDataAccess
    {
        ...
        public async Task<EmailTemplateSettings> GetEmailTemplateSettings()
        {
            ...
            TA.CommonLibrary.Talent.FalconEntities.Common.EmailTemplateSettings emailTemplateSettings = await client.GetFirstOrDefault<TA.CommonLibrary.Talent.FalconEntities.Common.EmailTemplateSettings>(f => f.Type == "EmailTemplateSettings");

            return this.ConvertToEmailTemplateSettings(emailTemplateSettings);
        }

        private EmailTemplateSettings ConvertToEmailTemplateSettings(TA.CommonLibrary.Talent.FalconEntities.Common.EmailTemplateSettings emailTemplateSettingsEntity)
        {
