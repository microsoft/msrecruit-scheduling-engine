...
// </copyright>
// This file is auto-generated by the TA.CommonLibrary.Talent/TalentContracts/ContractGenerator.tst script.
//---------------------------------------------------------------------------
${
    ...
    && (c.Namespace == "TA.CommonLibrary.Common.TalentAttract.Contract" || 
    c.Namespace == "TA.CommonLibrary.Talent.TalentContracts.TeamsIntegration" ||
    c.Namespace == "TA.CommonLibrary.ScheduleService.Contracts.V1" ||
    c.Namespace == "TA.CommonLibrary.Talent.TalentContracts.ScheduleService" ||
    c.Namespace == "TA.CommonLibrary.Talent.TalentContracts.ScheduleService.Conferencing" ||
    c.Namespace == "TA.CommonLibrary.Talent.TalentContracts.Flighting" ||
    c.Namespace == "TA.CommonLibrary.Common.Contracts" ||
    c.Namespace == "TA.CommonLibrary.Talent.TalentContracts.TalentMatch"||
    c.Namespace == "TA.CommonLibrary.Common.TalentEntities.Common" ||
    (c.Namespace == "TA.CommonLibrary.Common.SchedulingService.Contracts" && c.Name !="EmailTemplate") ||
    (c.Namespace == "TA.CommonLibrary.Common.Provisioning.Entities.FalconEntities.Attract" && c.Name == "JobApplicationParticipant") ||
    c.Namespace == "TA.CommonLibrary.Talent.EnumSetModel.SchedulingService"  ||
    c.Namespace == "TA.CommonLibrary.Common.EnvironmentSettings.Contracts" ||
    c.Namespace == "TA.CommonLibrary.Common.Email.Contracts" ||
    c.Namespace == "TA.CommonLibrary.Common.Web.Contracts" ||
	c.Namespace == "TA.CommonLibrary.Talent.TalentContracts.InterviewService" ||
    c.Namespace == "TA.CommonLibrary.Talent.TalentContracts.QueryStringParameters")
    || c.Name == "OfferUser"
...
export interface $GetClassName {$Properties(p => p.Attributes.Any(a => a.Name != "IgnoreDataMember"))[
    ...
    c.Attributes.Any(a => a.Name == "DataContract")
    && c.BaseClass != null && (c.Namespace == "TA.CommonLibrary.Common.TalentAttract.Contract" || 
    c.Namespace == "TA.CommonLibrary.ScheduleService.Contracts.V1" ||    
    c.Namespace == "TA.CommonLibrary.Common.Contracts" ||
    c.Namespace == "TA.CommonLibrary.Common.Web.Contracts" ||
    c.Namespace == "TA.CommonLibrary.Talent.TalentContracts.Flighting" ||
