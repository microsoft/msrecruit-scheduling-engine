...
using CommonLibrary.ServicePlatform.Caching.Activities;
using CommonLibrary.ServicePlatform.Context;
using Microsoft.Extensions.Caching.Memory;

namespace CommonLibrary.ServicePlatform.Caching
{
    /// <summary>
    /// An implementation of a cache where entries share a common type.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <seealso cref="CommonLibrary.ServicePlatform.Caching.Abstractions.ICache{T}" />
