...
using Activity = CommonLibrary.ServicePlatform.Context.ServiceContext.Activity;
...
namespace CommonLibrary.ServicePlatform.Context
{
    ...
    public static class ActivityLoggerExtensions
    {
        ...
        {
            CommonLibrary.CommonDataService.Common.Internal.Contract.CheckValue(activityType, nameof(activityType));
            CommonLibrary.CommonDataService.Common.Internal.Contract.CheckValue(action, nameof(action));
        ...
        {
            CommonLibrary.CommonDataService.Common.Internal.Contract.CheckValue(activityType, nameof(activityType));
            CommonLibrary.CommonDataService.Common.Internal.Contract.CheckValue(func, nameof(func));
        ...
        {
            CommonLibrary.CommonDataService.Common.Internal.Contract.CheckValue(rootContext, nameof(rootContext));
            CommonLibrary.CommonDataService.Common.Internal.Contract.CheckValue(activityType, nameof(activityType));
            CommonLibrary.CommonDataService.Common.Internal.Contract.CheckValue(action, nameof(action));
        ...
        {
            CommonLibrary.CommonDataService.Common.Internal.Contract.CheckValue(activityType, nameof(activityType));
            CommonLibrary.CommonDataService.Common.Internal.Contract.CheckValue(stopwatch, nameof(stopwatch));
            try
            {
                logger.Log(LogLevel.Information, ActivityLogData.End(activityType, stopwatch));
            }
