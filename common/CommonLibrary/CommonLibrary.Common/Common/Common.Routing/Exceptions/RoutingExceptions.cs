...
namespace CommonLibrary.Common.Routing.Exceptions
{
    /// <summary>
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.Routing.Exceptions", "GlobalService_Exception", MonitoredExceptionKind.Service)]
    ...
    [SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass",
       Justification = "Small closely related classes may be combined.")]
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "CommonLibrary.Common.Routing.Exceptions", "GlobalServiceInvalidOperation_Exception", MonitoredExceptionKind.Benign)]
    ...
    [SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass",
       Justification = "Small closely related classes may be combined.")]
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.Routing.Exceptions", "GlobalServiceMappingsRetrieval_Exception", MonitoredExceptionKind.Service)]
