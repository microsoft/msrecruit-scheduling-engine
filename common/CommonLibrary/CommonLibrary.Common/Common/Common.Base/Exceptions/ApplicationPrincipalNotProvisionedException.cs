...
namespace CommonLibrary.Common.Base.Exceptions
{
    ...
    [Serializable]
    [MonitoredExceptionMetadata(HttpStatusCode.Unauthorized, "CommonLibrary.Common.Base.Exceptions", nameof(ApplicationPrincipalNotProvisionedException), MonitoredExceptionKind.Benign)]
