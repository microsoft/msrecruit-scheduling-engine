...
//-----------------------------------------------------------------------
namespace CommonLibrary.Common.Web.Exceptions
{
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.Web", "RolePorviderRemoteServiceException", MonitoredExceptionKind.Benign)]
    [Serializable]
    ...
    /// </summary>
    [SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass", Justification = "Small closely related classes may be combined.")]
    [MonitoredExceptionMetadata(HttpStatusCode.Forbidden, "CommonLibrary.Common.Web", "RoleProviderUnauthorizedException", MonitoredExceptionKind.Benign)]
    [Serializable]
