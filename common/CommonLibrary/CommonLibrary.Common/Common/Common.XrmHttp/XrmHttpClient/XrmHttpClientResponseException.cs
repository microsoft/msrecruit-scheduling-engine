...
namespace CommonLibrary.Common.XrmHttp
{
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", nameof(XrmHttpClientResponseException), MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMBadRequest", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotFound, "CommonLibrary.Common.XrmHttp", "XRMNotFound", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.Unauthorized, "CommonLibrary.Common.XrmHttp", "XRMUnauthorized", MonitoredExceptionKind.Benign)]
    public class XrmHttpClientUnauthorizedResponseException : XrmHttpClientResponseException
    {
        ...
        [ExceptionCustomData(Name = CommonLibrary.Common.Base.Constants.ExceptionErrorTypeName, PrivacyLevel = PrivacyLevel.PublicData, Serialize = true)]
        public int ErrorType => (int)Base.ErrorType.Benign;
    }

    [MonitoredExceptionMetadata(HttpStatusCode.Forbidden, "CommonLibrary.Common.XrmHttp", "XRMForbidden", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.BadGateway, "CommonLibrary.Common.XrmHttp", "XRMBadGateway", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMPreconditionFailed", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMTooManyRequests", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMConflict", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMInternalServerError", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", nameof(XrmHttpClientCustomerPluginException), MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMPluginExecutionFailedException", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XrmMissingAK", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XrmRequestHeadersTooLong", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMUnrecognizedPath", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMUnknownProperty", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "CommonLibrary.Common.XrmHttp", "XRMValidationFailed", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "CommonLibrary.Common.XrmHttp", "XRMInvalidCharactersInField", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotFound, "CommonLibrary.Common.XrmHttp", "XRMUserDisabled", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMDuplicateKeyValues", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMDuplicateAlternateKeyValues", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.Forbidden, "CommonLibrary.Common.XrmHttp", "XRMNoUserRolesAssigned", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "CommonLibrary.Common.XrmHttp", "XRMOrganizationServiceFault", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotImplemented, "CommonLibrary.Common.XrmHttp", "XRMRelevanceSearchNotAllowed", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotImplemented, "CommonLibrary.Common.XrmHttp", "XRMFetchXMLAggregateQueryRecordLimitExceeded", MonitoredExceptionKind.Remote)]
