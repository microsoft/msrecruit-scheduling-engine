...
namespace HR.TA.Data.DataAccess
{
    ...
    public class EmailTemplateDataAccess : IEmailTemplateDataAccess
    {
        ...
        public async Task<EmailTemplateSettings> GetEmailTemplateSettings()
        {
            ...
            HR.TA.Talent.FalconEntities.Common.EmailTemplateSettings emailTemplateSettings = await client.GetFirstOrDefault<HR.TA.Talent.FalconEntities.Common.EmailTemplateSettings>(f => f.Type == "EmailTemplateSettings");
