...
using Activity = HR.TA.ServicePlatform.Context.ServiceContext.Activity;
...
namespace HR.TA.ServicePlatform.Context
{
    ...
    public static class ActivityLoggerExtensions
    {
        ...
        {
            HR.TA.CommonDataService.Common.Internal.Contract.CheckValue(activityType, nameof(activityType));
            HR.TA.CommonDataService.Common.Internal.Contract.CheckValue(action, nameof(action));
        ...
        {
            HR.TA.CommonDataService.Common.Internal.Contract.CheckValue(activityType, nameof(activityType));
            HR.TA.CommonDataService.Common.Internal.Contract.CheckValue(func, nameof(func));
        ...
        {
            HR.TA.CommonDataService.Common.Internal.Contract.CheckValue(rootContext, nameof(rootContext));
            HR.TA.CommonDataService.Common.Internal.Contract.CheckValue(activityType, nameof(activityType));
            HR.TA.CommonDataService.Common.Internal.Contract.CheckValue(action, nameof(action));
        ...
        {
            HR.TA.CommonDataService.Common.Internal.Contract.CheckValue(activityType, nameof(activityType));
            HR.TA.CommonDataService.Common.Internal.Contract.CheckValue(stopwatch, nameof(stopwatch));
            try
            {
                logger.Log(LogLevel.Information, ActivityLogData.End(activityType, stopwatch));
            }
