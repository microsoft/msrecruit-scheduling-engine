...
namespace HR.TA.Common.Product.ServicePlatform.Instrumentation.ApplicationInsights
{
    ...
    /// </summary>
    /// <seealso cref="HR.TA.Common.Product.ServicePlatform.Instrumentation.ITraceEventProvider" />
