...
namespace HR.TA.Common.XrmHttp
{
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", nameof(XrmHttpClientResponseException), MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMBadRequest", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotFound, "HR.TA.Common.XrmHttp", "XRMNotFound", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.Unauthorized, "HR.TA.Common.XrmHttp", "XRMUnauthorized", MonitoredExceptionKind.Benign)]
    public class XrmHttpClientUnauthorizedResponseException : XrmHttpClientResponseException
    {
        ...
        [ExceptionCustomData(Name = HR.TA.Common.Base.Constants.ExceptionErrorTypeName, PrivacyLevel = PrivacyLevel.PublicData, Serialize = true)]
        public int ErrorType => (int)Base.ErrorType.Benign;
    }

    [MonitoredExceptionMetadata(HttpStatusCode.Forbidden, "HR.TA.Common.XrmHttp", "XRMForbidden", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.BadGateway, "HR.TA.Common.XrmHttp", "XRMBadGateway", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMPreconditionFailed", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMTooManyRequests", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMConflict", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMInternalServerError", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", nameof(XrmHttpClientCustomerPluginException), MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMPluginExecutionFailedException", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XrmMissingAK", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XrmRequestHeadersTooLong", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMUnrecognizedPath", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMUnknownProperty", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "HR.TA.Common.XrmHttp", "XRMValidationFailed", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "HR.TA.Common.XrmHttp", "XRMInvalidCharactersInField", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotFound, "HR.TA.Common.XrmHttp", "XRMUserDisabled", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMDuplicateKeyValues", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMDuplicateAlternateKeyValues", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.Forbidden, "HR.TA.Common.XrmHttp", "XRMNoUserRolesAssigned", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.XrmHttp", "XRMOrganizationServiceFault", MonitoredExceptionKind.Remote)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotImplemented, "HR.TA.Common.XrmHttp", "XRMRelevanceSearchNotAllowed", MonitoredExceptionKind.Benign)]
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.NotImplemented, "HR.TA.Common.XrmHttp", "XRMFetchXMLAggregateQueryRecordLimitExceeded", MonitoredExceptionKind.Remote)]
