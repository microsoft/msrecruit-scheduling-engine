...
namespace HR.TA.Common.MSGraph.Exceptions
{
    using System;
    ...
    [Serializable]
    [MonitoredExceptionMetadata(HttpStatusCode.ServiceUnavailable, "HR.TA.Common.MsGraph", "MsGraphServiceUnavailableException", MonitoredExceptionKind.Service)]
    public sealed class MsGraphServiceUnavailableException : MonitoredException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HR.TA.Common.MSGraph.Exceptions.MsGraphServiceUnavailableException" /> class.
        /// </summary>
    ...
    [SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass", Justification = "Small closely related classes may be combined.")]
    [Serializable]
    [MonitoredExceptionMetadata(HttpStatusCode.BadRequest, "HR.TA.Common.MsGraph", "MsGraphInvalidInputException", MonitoredExceptionKind.Service)]
    public sealed class MsGraphInvalidInputException : MonitoredException
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HR.TA.Common.MSGraph.Exceptions.MsGraphInvalidInputException" /> class.
        /// </summary>
        /// <param name="exception">Exception during graph call.</param>
    ...
    [SuppressMessage("StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass", Justification = "Small closely related classes may be combined.")]
    [Serializable]
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.Common.MsGraph", "AcquireGraphTokenException", MonitoredExceptionKind.Service)]
