...
namespace HR.TA.Common.Web.DelegatingHandlers
{
    using System;
    using System.Net;
                ...
                async () =>
                {
                    try
                    {
                        ...
                        while (DateTime.UtcNow < timeout)
                        {
                            ...
                            newRequest.Headers.Authorization = new AuthenticationHeaderValue(HR.TA.Common.Base.Constants.BearerAuthenticationScheme, token);
