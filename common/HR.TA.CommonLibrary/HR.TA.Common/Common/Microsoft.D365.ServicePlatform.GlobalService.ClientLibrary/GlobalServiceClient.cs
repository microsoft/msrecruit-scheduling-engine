...
using HR.TA.ServicePlatform.Caching;
using HR.TA.ServicePlatform.Caching.Abstractions;
...
using GSContracts = HR.TA.ServicePlatform.GlobalService.Contracts.Client;

namespace HR.TA.ServicePlatform.GlobalService.ClientLibrary
{
    /// <summary>
    /// Implementation of global service client.
    /// </summary>
    /// <seealso cref="HR.TA.ServicePlatform.GlobalService.ClientLibrary.IGlobalServiceClient" />
