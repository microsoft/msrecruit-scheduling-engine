...
// </copyright>
// This file is auto-generated by the HR.TA.Talent/TalentContracts/ContractGenerator.tst script.
//---------------------------------------------------------------------------
${
    ...
    && (c.Namespace == "HR.TA.Common.TalentAttract.Contract" || 
    c.Namespace == "HR.TA.Talent.TalentContracts.TeamsIntegration" ||
    c.Namespace == "HR.TA.ScheduleService.Contracts.V1" ||
    c.Namespace == "HR.TA.Talent.TalentContracts.ScheduleService" ||
    c.Namespace == "HR.TA.Talent.TalentContracts.ScheduleService.Conferencing" ||
    c.Namespace == "HR.TA.Talent.TalentContracts.Flighting" ||
    c.Namespace == "HR.TA.Common.Contracts" ||
    c.Namespace == "HR.TA.Talent.TalentContracts.TalentMatch"||
    c.Namespace == "HR.TA.Common.TalentEntities.Common" ||
    (c.Namespace == "HR.TA.Common.SchedulingService.Contracts" && c.Name !="EmailTemplate") ||
    (c.Namespace == "HR.TA.Common.Provisioning.Entities.FalconEntities.Attract" && c.Name == "JobApplicationParticipant") ||
    c.Namespace == "HR.TA.Talent.EnumSetModel.SchedulingService"  ||
    c.Namespace == "HR.TA.Common.EnvironmentSettings.Contracts" ||
    c.Namespace == "HR.TA.Common.Email.Contracts" ||
    c.Namespace == "HR.TA.Common.Web.Contracts" ||
	c.Namespace == "HR.TA.Talent.TalentContracts.InterviewService" ||
    c.Namespace == "HR.TA.Talent.TalentContracts.QueryStringParameters")
    || c.Name == "OfferUser"
...
export interface $GetClassName {$Properties(p => p.Attributes.Any(a => a.Name != "IgnoreDataMember"))[
    ...
    c.Attributes.Any(a => a.Name == "DataContract")
    && c.BaseClass != null && (c.Namespace == "HR.TA.Common.TalentAttract.Contract" || 
    c.Namespace == "HR.TA.ScheduleService.Contracts.V1" ||    
    c.Namespace == "HR.TA.Common.Contracts" ||
    c.Namespace == "HR.TA.Common.Web.Contracts" ||
    c.Namespace == "HR.TA.Talent.TalentContracts.Flighting" ||
