// <copyright file="CandidateCommunicator_SendIInvitationAsyncTests.cs" company="Microsoft Corporation">
...
namespace MS.GTA.ScheduleService.UnitTest.Business.NotifyCandidate
{
    ...
    public class CandidateCommunicator_SendIInvitationAsyncTests
    {
        ...
        public async Task SendInvitationAsync_ValidInput()
        {
            ...
            this.notificationClientMock.Setup(nc => nc.SendEmail(It.IsAny<List<NotificationItem>>())).ReturnsAsync(true);
