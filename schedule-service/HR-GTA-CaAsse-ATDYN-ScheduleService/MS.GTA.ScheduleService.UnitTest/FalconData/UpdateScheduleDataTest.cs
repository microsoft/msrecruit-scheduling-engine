    ...
    public class UpdateScheduleDataTest
    {
        ...
        public void UpdateScheduleStatusTestWithNullInputs()
        {
            ...
            logger.ExecuteRoot(
               ...
               () =>
               {
                   var exception = this.scheduleQuery.UpdateScheduleStatus(string.Empty, GTA.Talent.EnumSetModel.ScheduleStatus.NotScheduled).Exception;
        ...
        public void UpdateScheduleStatusTestWithValidData()
        {
            ...
            logger.ExecuteRoot(
               ...
               () =>
               {
                   ...
                   var result = this.scheduleQuery.UpdateScheduleStatus("12345", GTA.Talent.EnumSetModel.ScheduleStatus.Queued);
        ...
        public void UpdateScheduleWithResponseTestWithoutEvent()
        {
            ...
            logger.ExecuteRoot(
               ...
               () =>
               {
                   var result = this.scheduleQuery.UpdateScheduleWithResponse(message, It.IsAny<Microsoft.Graph.User>()).Exception;
        ...
        public void UpdateScheduleWithResponseTestWithoutSchedule()
        {
            ...
            Message message = new Message()
            {
                Body = new GTA.ScheduleService.Contracts.V1.CalendarBody(),
                Event = new CalendarEvent()
                {
                    Id = Guid.NewGuid().ToString(),
                },
            ...
            logger.ExecuteRoot(
               ...
               () =>
               {
                   ...
                   var result = this.scheduleQuery.UpdateScheduleWithResponse(message, null).Exception;
        ...
        public void UpdateScheduleWithResponseTestWithDeclined()
        {
            ...
            logger.ExecuteRoot(
               ...
               () =>
               {
                   ...
                   var result = this.scheduleQuery.UpdateScheduleWithResponse(message, null);
        ...
        public void UpdateScheduleTestWithValidResponseData()
        {
            ...
            JobApplicationSchedule jobApplication = new JobApplicationSchedule();
            jobApplication.ScheduleID = Guid.NewGuid().ToString();
            jobApplication.ScheduleStatus = GTA.Talent.EnumSetModel.ScheduleStatus.Queued;
            jobApplication.ServiceAccountEmail = "Test@microsoft.com";
            jobApplication.Description = "test";
            jobApplication.StartDateTime = DateTime.UtcNow;
            jobApplication.EndDateTime = DateTime.Today;
