//----------------------------------------------------------------------------
// <copyright file="IScheduleQuery.cs" company="Microsoft Corporation">
...
namespace MS.GTA.ScheduleService.Data.DataProviders
{
    ...
    public interface IScheduleQuery
    {
        ...
        /// <param name="graphUser">user details</param>
        /// <returns>The instance of <see cref="InterviewerInviteResponseInfo"/>.</returns>
        Task<InterviewerInviteResponseInfo> UpdateScheduleWithResponse(Message message, Microsoft.Graph.User graphUser);
