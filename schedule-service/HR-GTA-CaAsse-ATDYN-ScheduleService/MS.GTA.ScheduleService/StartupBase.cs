...
namespace MS.GTA.ScheduleService
{
    ...
    using CommonLibrary.Common.Common.WebNotifications.Configurations;
    using CommonLibrary.Common.DocumentDB.V2;
    using CommonLibrary.Common.Email;
    using CommonLibrary.Common.MSGraph;
    using CommonLibrary.Common.Product.ServicePlatform.AspNetCore.Builder;
    using CommonLibrary.Common.Product.ServicePlatform.Flighting.AppConfiguration;
    using CommonLibrary.Common.Product.ServicePlatform.Instrumentation.ApplicationInsights;
    using CommonLibrary.Common.Product.ServicePlatform.Utils;
    using CommonLibrary.Common.Routing.DocumentDb;
    using CommonLibrary.Common.Routing.Extensions;
    using CommonLibrary.Common.Web.Extensions;
    ...
    using CommonFalconQuery = CommonLibrary.Common.Routing.Client;
