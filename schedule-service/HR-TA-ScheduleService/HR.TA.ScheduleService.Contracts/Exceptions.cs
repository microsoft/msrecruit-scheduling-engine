...
namespace HR.TA.ScheduleService.Contracts
{
    using System;
    ...
    [MonitoredExceptionMetadata(HttpStatusCode.InternalServerError, "HR.TA.InterviewService.Exceptions", "OperationFailure", MonitoredExceptionKind.Service)]
